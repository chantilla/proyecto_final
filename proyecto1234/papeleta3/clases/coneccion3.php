<?php
    $dsn = 'mysql:dbname=elecciones;host=127.0.0.1';
    $usuario = 'root';
    $clave = '';   
    ...
    function consultaA($coneccion, $sql)
    {
      ...
      try {
          ...
          {
              case "INSERT":
                  $msgerror = "LOSENTIMOS EL DUI QUE USTED TRATA DE INGRESAR YA ESTA EN NUESTRO SISTEMA PORFAVOR INGRESAR UN NUMERO DE DUI DISTINTO";
  ...
  if ($objeto != NULL) {
    if (is_array($objeto)) {
      ...
      foreach ($objeto as $datos) {
        ...
        if($editar != "0" ){
          $tabla .=  "<td><a href=".$form."alumnoBuscar.php?id=".$datos['id_candidato'].">Modificar</a></td>";
          $tabla .=  "<td><a href=".$form."alumnoBorrar.php?id=".$datos['id_candidato'].">Eliminar</a></td>";  
