  ...
  if ($objeto != NULL) {
    if (is_array($objeto)) {
      ...
      foreach ($objeto as $datos) {
        ...
        if($editar != "0" ){
          $tabla .=  "<td><a href=".$form."alumnoBuscar.php?id=".$datos['id_ciudadano'].">Modificar</a></td>";
          $tabla .=  "<td><a href=".$form."ciudadanoBorrar.php?id=".$datos['id_ciudadano'].">Eliminar</a></td>";  
